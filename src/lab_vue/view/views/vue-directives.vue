<template>
  <article class="flex-middle">
    ...
    <p v-test:id="test">Here will be replaced</p>
...
export default {
  ...
  directives: {
    ...
    test: {
      bind: function(el, binding, vnode, oldVnode) { console.log('[bind]', el, binding, vnode, oldVnode); console.log('[Bind]'); },
      inserted: function(el, binding, vnode, oldVnode) { console.log('[inserted]')},
      update: function(el, binding, vnode, oldVnode) { console.log('[update]'); el.innerHTML = binding.value },
